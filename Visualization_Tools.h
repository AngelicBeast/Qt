...
inline Polyhedron createDisk(Point_d p, Vector_3 normal, double radius)
{
	Polyhedron P;
...
inline Polyhedron createEllipse(Point_d p, Vector_3 normal, double a, double b,int step)
{
	Polyhedron P;
...
inline Polyhedron createCone(Point_d p, Vector_3 normal, double radius, double height)
{
	Polyhedron P;
...
inline Polyhedron createSquare(std::vector < Point_d > vp)
{
	Polyhedron P;
...
inline Polyhedron createCube(std::vector < Point_d > vp)
{
	Polyhedron P;
...
inline Polyhedron createArrow(Point_d p1, Point_d p2, double size)
{
	Polyhedron P;
...
inline Polyhedron createDashedCylinder(Point_d p1, Point_d p2, double size)
{
...
inline Polyhedron createDashedCylinder2(Point_d p1, Point_d p2, double size)
{
...
inline Polyhedron createSphere(Point_d p, double size)
{
	Polyhedron P;
	double step=15;
...
inline Polyhedron createSpherette(Point_d p, double size, int step)
{
	Polyhedron P;
	Build_sphere<HalfedgeDS> poly1(p,size,true,step);
	P.delegate(poly1);
...
inline Polyhedron createSphere_fine(Point_d p, double size)
{
	Polyhedron P;
	double step=30;
	Build_sphere<HalfedgeDS> poly1(p,size,true,step);
...
inline Polyhedron createCylinder(Point_d p1, Point_d p2, double size)
{
	Polyhedron P;
	double step=90;
	Build_cylinder<HalfedgeDS> poly1(p1,p2,size,true,step);
...
inline Polyhedron createCylinder_fine(Point_d p1, Point_d p2, double size)
{
	Polyhedron P;
	double step=30;
	Build_cylinder<HalfedgeDS> poly1(p1,p2,size,true,step);
...
inline bool save_listpolyhedron2ply(std::vector<Polyhedron> lP, char *nom, std::vector<CGAL::Color> lC)
{
...
// bool save_list_polyhedron_plus_other_ponits_to_ply(std::vector<Polyhedron> lP, char *nom, std::vector<CGAL::Color> lC, std::vector< Point_d > other_points)
// {
// 	std::cout <<"Saving polyhedron to "<<nom<<std::endl;
// 	OFSTREAM_TEXTE(fic,nom);
...
// 		nb_facets+=(*it).size_of_facets ();
// 	}
// 	nb_vertices += (int) other_points.size();
...
inline bool colorplanset2ply( char * filename, std::vector < std::vector < Point_d > > & pt, std::vector< CGAL::Color > & colors)
	{
...
inline bool color_inliers( char * filename, std::vector < std::vector < Point_d > > & pt, std::vector< CGAL::Color > & colors)
	{
...
inline bool colorpointset2ply( char * filename, std::vector< Point_d > & points, std::vector< CGAL::Color > & colors)
	{
		std::cout <<"Saving point clouds to "<<filename<<std::endl;
	OFSTREAM_TEXTE(fic,filename);
